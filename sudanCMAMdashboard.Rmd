...
output$statePerformanceMap <- renderLeaflet({
  ...
  palReverse <- colorNumeric(palette = mapPalette, 
                             domain = c(0, 100),
                             reverse = TRUE)
  
  palCure <- colorBin(palette = brewer.pal(n = 6, name = "RdYlGn"),
                      domain = c(0, 100),
  ...
  leaflet() %>%
    ...
    addPolygons(data = xstate_map(),
                fillColor = palCure(xstate_map()$`Cure Rate`),
                weight = 2,
                opacity = 1,
                color = palCure(xstate_map()$`Cure Rate`),
                dashArray = "",
                fillOpacity = 0.8,
                highlight = highlightOptions(weight = 3,
                                             ...
                                             fillOpacity = 0.7,
                                             bringToFront = TRUE),
                label = paste("<strong>", xstate_map()@data$State, 
                              " State</strong><br/><strong>Cure Rate:</strong> ", 
                              round(xstate_map()@data$`Cure Rate`, digits = 2), 
                ...
                group = "Cure") %>%
        addPolygons(data = xstate_map(),
                    fillColor = palReverse(xstate_map()$`Defaulter Rate`),
                    weight = 2,
                    opacity = 1,
                    color = palReverse(xstate_map()$`Defaulter Rate`),
                    dashArray = "",
                    fillOpacity = 0.8,
                    highlight = highlightOptions(weight = 3,
                                                 color = "#666",
                                                 ...
                                                 bringToFront = TRUE),
                    label = paste("<strong>", xstate_map()@data$State, 
                                  " State</strong><br/><strong>Defaulter Rate:</strong> ", 
                                  round(xstate_map()@data$`Defaulter Rate`, digits = 2), 
                                  "%<br/>", input$chosen_month, " ", 
                                  input$chosen_year, sep = "") %>%
                      lapply(FUN = htmltools::HTML),
                    labelOptions = labelOptions(style = list("font-weight" = "normal",
        ...
        addPolygons(data = xstate_map(),
                    ...
                    highlight = highlightOptions(weight = 3,
                                                 ...
                                                 bringToFront = TRUE),
                    label = paste("<strong>", xstate_map()@data$State, 
                                  " State</strong><br/><strong>Death Rate:</strong> ", 
                                  round(xstate_map()@data$`Death Rate`, digits = 2), 
                                  "%<br/>", input$chosen_month, " ", 
                                  input$chosen_year, sep = "") %>%
                      lapply(FUN = htmltools::HTML),
                    labelOptions = labelOptions(style = list("font-weight" = "normal", 
        ...
        addPolygons(data = xstate_map(),
                    ...
                    highlight = highlightOptions(weight = 3,
                                                 ...
                                                 bringToFront = TRUE),
                    label = paste("<strong>", xstate_map()@data$State, 
                                  " State</strong><br/><strong>Non-response Rate:</strong> ", 
                                  round(xstate_map()@data$`Non-response Rate`, digits = 2), 
                                  "%<br/>", input$chosen_month, " ", 
                                  input$chosen_year, sep = "") %>%
                      lapply(FUN = htmltools::HTML),
                    labelOptions = labelOptions(style = list("font-weight" = "normal", 
