...
renderValueBox({
  valueBox(
    ...
    icon = if( yearLocalityTotal()$`Cured %` <= 75) "fa-thumbs-down" else "fa-thumbs-up",
    color = if (yearLocalityTotal()$`Cured %` <= 75) "danger" else "success"
  )
})
```
...
renderValueBox({
  valueBox(
    ...
    caption = paste(input$locality_name, "Locality,", 
                    ...
                    input$chosen_year, sep = " "),
    icon = if( yearLocalityTotal()$`Defaulted %` >= 15) "fa-thumbs-down" else "fa-thumbs-up",
    color = if (yearLocalityTotal()$`Defaulted %` >= 15) "danger" else "success"
  )
})
```
...
renderValueBox({
  valueBox(
    ...
    caption = paste(input$locality_name, "Locality,", 
                    ...
                    input$chosen_year, sep = " "),
    icon = if( yearLocalityTotal()$`Dead %` >= 10) "fa-thumbs-down" else "fa-thumbs-up",
    color = if (yearLocalityTotal()$`Dead %` >= 10) "danger" else "success"
  )
})
```
...
renderValueBox({
  valueBox(
    ...
    caption = paste(input$locality_name, "Locality,",
                    ...
                    input$chosen_year, sep = " "),
    icon = if( yearLocalityTotal()$`Non-responder %` >= 5) "fa-thumbs-down" else "fa-thumbs-up",
    color = if (yearLocalityTotal()$`Non-responder %` >= 5) "danger" else "success"
  )
})
```
